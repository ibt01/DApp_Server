...
public class EcSignature {
    ...
    public EcSignature( String base58Str ){
        ...
        this.curveParam = TLKEcUtil.getCurveParamFrom( parts[1]);
        byte[] rawBytes = TLKEcUtil.getBytesIfMatchedRipemd160( parts[2], parts[1], null);
    ...
    public String olsEncodingHex(boolean compressed ) {
        if ( recId < 0 || recId > 3) {
        ...
        return TLKEcUtil.encodeEosCrypto( PREFIX, curveParam , sigData);
    }
